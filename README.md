...
*   **⚔️ Attack Surface Mapper:** Automatically correlates `AndroidManifest.xml` (Exported Components) with AI Code Analysis to generate a strategic "Attacker's Map". [Read the Docs](Attack_Surface_Mapper.md)
